...
#div2{background: url("img/register.jpg");
...
<form action="UserServlets?opr=reg" method="post">
	<table width="511px" cellspacing="4px" cellpadding="1px" style="margin-left:100px;" >
		...
		<td colspan="2"><input type="password" placeholder="仅限大陆手机用户"  style="display:block; width:250px; height:35px" id="phone" name="phone"/></td>
		  ...
		  <tr>
		    <td height="86"  style="font-size:13px; font-weight:bold; color:white" >邮箱账号</td>
		<td colspan="2">
		<input type="email" placeholder="账号如xx@xxx.xxx"  style="display:block; width:250px; height:35px" id="email" name="email"/></td>
		    <td id="v5">&nbsp;</td>
		  </tr>
