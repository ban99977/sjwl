...
<html>
 ...
 <%@ include file="header.jsp" %>
  ...
  <div id="left">
    ...
    <span><a href="GoodsServlet?opr=det&id=10105">360N7</a> <a href="GoodsServlet?opr=det&id=10101">360N7P</a> <a href="GoodsServlet?opr=det&id=10102">360Q5<sup><img src="img/new.gif" /></sup></a></span>
    </div>
    <div>
    <h3><a href="#">奇酷手机</a></h3>
    ...
    <div>
    <h3><a href="#">能源类</a></h3>
    <span><a href="GoodsServlet?opr=det&id=10106">移动电源</a> <a href="#">充电器</a> <a href="#">线材</a> <a href="#">电池</a></span>
    </div> 
    <div>
    <h3><a href="#">耳机与音箱</a></h3>
    <span><a href="GoodsServlet?opr=det&id=10107">线控耳机</a> <a href="#">蓝牙耳机</a></span>
    </div>
  </div>
 <div class="right">
            <ul class="img">
