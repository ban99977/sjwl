...
<script type="text/javascript">
  ...
  <div>
   <form action="GoodsServlet?opr=fuzzy&from=admin" method="post">
     <table id="table1">
      	 <caption>货物信息管理</caption>
    	 <tr><td>货品关键字:<input type="text" name="goods"/>&nbsp;&nbsp;<input type="submit" value="查询">&nbsp;&nbsp;<a href="insertGoods.jsp"><input type="button" value="添加商品"></a></td></tr>
     </table>
     </form>
   ...
   <tr style="text-align: center;">
    <td colspan="5"><a href="UserServlets?opr=list">用户信息管理</a></td><td colspan="5"><a href="admin.jsp">管理首页</a></td></tr>
     </table>
     </form>
